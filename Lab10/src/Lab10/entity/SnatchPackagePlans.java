 ...
 */
public abstract class SnatchPackagePlans  extends PackagePlans  {
    ...
    public SnatchPackagePlans(int id) throws PackagePlansExceptions {
        super(id);
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 19 * hash + this.payment;
        hash = 19 * hash + this.outcomingToHardLife3G;
        hash = 19 * hash + this.outcomingToOtherOperators2G;
        hash = 19 * hash + this.internetTraffic;
        hash = 19 * hash + this.numberOfUsers;
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SnatchPackagePlans other = (SnatchPackagePlans) obj;
