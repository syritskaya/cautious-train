 ...
 */
public class GodzillaPlan extends AllInPackagePlans{

    public GodzillaPlan(int id, int payment,int outcomingToHardLife3G, int outcomingToOtherOperators2G, int internetTraffic,int internationalCalls, int alJazeeraTVChannel, int numberOfUsers ) throws IOException, PackagePlansExceptions {
        super(id);
        setPayment(payment);
     ...
     public String toString() {
         ...
         msg.append("The information about Godzilla plan: " + "\n");
