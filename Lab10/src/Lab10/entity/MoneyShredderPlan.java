 ...
 */
public class MoneyShredderPlan extends AllInPackagePlans{

    public MoneyShredderPlan(int id, int payment,int outcomingToHardLife3G, int outcomingToOtherOperators2G, int internetTraffic,int internationalCalls, int alJazeeraTVChannel, int numberOfUsers ) throws IOException, PackagePlansExceptions {
        super(id);
        setPayment(payment);
     ...
     public String toString() {
         ...
         msg.append("The information about Money Shredder plan: " + "\n");
