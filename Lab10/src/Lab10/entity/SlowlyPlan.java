 ...
 */
public class SlowlyPlan extends OnlyInternetPackagePlans{

    public SlowlyPlan(int id, int payment, int internetTraffic,int price1Mb, int numberOfUsers ) throws IOException, PackagePlansExceptions {
        super(id);
        setPayment(payment);
     ...
     public String toString() {
         ...
         msg.append("The information about Slowly plan: " + "\n");
