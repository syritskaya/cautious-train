...
public class DialUpPlan extends OnlyInternetPackagePlans{

    public DialUpPlan(int id, int payment, int internetTraffic,int price1Mb, int numberOfUsers ) throws IOException, PackagePlansExceptions {
        super(id);
        setPayment(payment);
     ...
     public String toString() {
         ...
         msg.append("The information about DialUp plan: " + "\n");
