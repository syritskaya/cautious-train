 ...
 */
public class NoFunPlan extends SnatchPackagePlans{

    public NoFunPlan(int id, int payment,int outcomingToHardLife3G, int outcomingToOtherOperators2G, int internetTraffic, int numberOfUsers ) throws IOException, PackagePlansExceptions {
        super(id);
        setPayment(payment);
     ...
     public String toString() {
         ...
         msg.append("The information about NoFun plan: " + "\n");
